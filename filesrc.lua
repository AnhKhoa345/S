...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>AnhKhoa2.0chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "AnhKhoa2.0", HidePremium = false, IntroText = "AnhKhoa2.0⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("AnhKhoa2.0SCRIPT")
W:AddLabel("DiscordAnhKhoa2.0")
local Section = W:AddSection({
    Name = "Status"
})
